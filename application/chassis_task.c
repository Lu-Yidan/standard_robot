...
static void chassis_vector_to_mecanum_wheel_speed(const fp32 vx_set, const fp32 vy_set, const fp32 wz_set, fp32 wheel_speed[4])
{
    ...
    wheel_speed[0] = 	(SQRT2_2)*param*vx_set - (SQRT2_2)*param*vy_set - R*param*wz_set;
    wheel_speed[1] = 	(SQRT2_2)*param*vx_set + (SQRT2_2)*param*vy_set - R*param*wz_set;
    wheel_speed[2] = -(SQRT2_2)*param*vx_set + (SQRT2_2)*param*vy_set - R*param*wz_set;
    wheel_speed[3] = -(SQRT2_2)*param*vx_set - (SQRT2_2)*param*vy_set - R*param*wz_set;  
